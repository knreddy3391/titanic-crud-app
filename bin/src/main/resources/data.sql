...
VALUES ('1,3,Miss. Laina Heikkinen,female,26,0,0,7.925');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. William Henry Allen,male,35,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. James Moran,male,27,0,0,8.4583');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Timothy J McCarthy,male,54,0,0,51.8625');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Master. Eugene Rice,male,2,4,1,29.125');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Mr. Charles Eugene Williams,male,23,0,0,13');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mrs. Fatima Masselmani,female,22,0,0,7.225');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Joseph J Fynney,male,35,0,0,26');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Mr. Lawrence Beesley,male,34,0,0,13');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Miss. Anna McGowan,female,15,0,0,8.0292');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Farred Chehab Emir,male,26,0,0,7.225');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES (
        '1,3,Miss. Ellen O' Dwyer,
        female,
        24,
        0,
        0,
        7.8792 ');
INSERT INTO Passenger (Survived,Pclass,Name,Sex,Age,SIBLINGS_SPOUSES_ABOARD,PARENTS_CHILDREN_ABOARD,Fare) VALUES (' 0,
        3,
        Mr.Lalio Todoroff,
        male,
        23,
...
INSERT INTO Passenger (Survived,Pclass,Name,Sex,Age,SIBLINGS_SPOUSES_ABOARD,PARENTS_CHILDREN_ABOARD,Fare) VALUES (' 0,
        ...
        0,
        27.7208 ');
INSERT INTO Passenger (Survived,Pclass,Name,Sex,Age,SIBLINGS_SPOUSES_ABOARD,PARENTS_CHILDREN_ABOARD,Fare) VALUES (' 1,
        1,
...
INSERT INTO Passenger (Survived,Pclass,Name,Sex,Age,SIBLINGS_SPOUSES_ABOARD,PARENTS_CHILDREN_ABOARD,Fare) VALUES (' 1,
        3,
        Miss.Bridget O 'Driscoll,female,27,0,0,7.75'
    );
INSERT INTO Passenger (
        Survived,
        Pclass,
...
VALUES ('0,3,Mr. Youssef Samaan,male,16,2,0,21.6792');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Mr. Hugh Woolner,male,46,0,0,35.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Emily Rugg,female,21,0,0,10.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Mansouer Novel,male,28.5,0,0,7.2292');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Orsen Sirayanian,male,22,0,0,7.2292');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Miss. Amelie Icard,female,38,0,0,80');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Master. Harald Skoog,male,4,3,2,27.9');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Albert A Stewart,male,64,0,0,27.7208');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Master. Gerios Moubarek,male,7,1,1,15.2458');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Ernest James Crease,male,19,0,0,8.1583');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Vincenz Kink,male,26,2,0,8.6625');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Stephen Curnow Jenkin,male,32,0,0,10.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Ambrose Jr Hood,male,21,0,0,73.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Lee Bing,male,32,0,0,56.4958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Sigurd Hansen Moen,male,25,0,0,7.65');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Ivan Staneff,male,23,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Rahamin Haim Moutal,male,28,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Achille Waelens,male,22,0,0,9');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Jan Baptist Sheerlinck,male,29,0,0,9.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Francisco M Carrau,male,28,0,0,47.1');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Bertha Ilett,female,17,0,0,10.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. William Neal Ford,male,16,1,3,34.375');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Francesco Celotti,male,24,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Emil Christmann,male,29,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Bertram Frank Dean,male,26,1,2,20.575');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Daniel Coxon,male,59,0,0,7.25');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Sinai Kantor,male,34,1,0,26');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Pastcho Petroff,male,29,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Stoytcho Mionoff,male,28,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Albert Johan Moss,male,29,0,0,7.775');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Tido Rekic,male,38,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Miss. Bertha Moran,female,28,1,0,24.15');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. David John Barton,male,22,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Miss. Katriina Jussila,female,20,1,0,9.825');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Miss. Malake Attalah,female,17,0,0,14.4583');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Edvard Pekoniemi,male,21,0,0,7.925');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Patrick Connors,male,70.5,0,0,7.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Leonard Charles Moore,male,19,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Nicholas Nasser,male,32.5,1,0,30.0708');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Susan Webber,female,32.5,0,0,13');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Martin McMahon,male,19,0,0,7.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Miss. Anna Peter,female,2,1,1,22.3583');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Johan Ekstrom,male,45,0,0,6.975');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Jozef Drazenoic,male,33,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Emile Richard,male,23,0,0,15.0458');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Olaf Elon Osen,male,16,0,0,9.2167');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Victor Giglio,male,24,0,0,79.2');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Miss. Anna Sofia Nysten,female,22,0,0,7.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Jeremiah Burke,male,19,0,0,6.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Edgardo Samuel Andrew,male,18,0,0,11.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Michel Navratil,male,36.5,0,2,26');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Alfonzo Meo,male,55.5,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Ole Martin Olsen,male,27,0,0,7.3125');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Harry Corn,male,30,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Mile Smiljanic,male,37,0,0,8.6625');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Master. Thomas Henry Sage,male,5,8,2,69.55');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. John Hatfield Cribb,male,44,0,1,16.1');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Jovo Calic,male,17,0,0,8.6625');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. John D Baumann,male,60,0,0,25.925');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Lee Ling,male,28,0,0,56.4958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Wyckoff Van der hoef,male,61,0,0,33.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Master. Arthur Rice,male,4,4,1,29.125');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Antti Wilhelm Sivola,male,21,0,0,7.925');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. James Clinch Smith,male,56,0,0,30.6958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Klas Albin Klasen,male,18,1,1,7.8542');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Reginald Hale,male,30,0,0,13');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Lionel Leonard,male,36,0,0,0');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Rene Pernot,male,39,0,0,15.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Master. Richard F Becker,male,1,2,1,39');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Hugh Roscoe Rood,male,39,0,0,50');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES (
        '1,3,Mrs. Thomas (Johanna Godfrey) O' Brien,
        female,
        26,
        1,
        0,
...
INSERT INTO Passenger (Survived,Pclass,Name,Sex,Age,SIBLINGS_SPOUSES_ABOARD,PARENTS_CHILDREN_ABOARD,Fare) VALUES (' 0,
        3,
        Mr.Thomas O 'Brien,male,27,1,0,15.5'
    );
INSERT INTO Passenger (
        Survived,
        Pclass,
...
VALUES ('1,3,Miss. Annie Jermyn,female,22,0,0,7.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. William Thomas Beavan,male,19,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Sante Ringhini,male,22,0,0,135.6333');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Harry Elkins Widener,male,27,0,2,211.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Tannous Betros,male,20,0,0,4.0125');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Miss. Rosalie Bidois,female,42,0,0,227.525');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Miss. Maria Nakid,female,1,0,2,15.7417');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Juho Tikkanen,male,32,0,0,7.925');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Vasil Plotcharsky,male,27,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Charles Henry Davies,male,18,0,0,73.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Kate Buss,female,36,0,0,13');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Matthew Sadlier,male,19,0,0,7.7292');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Bertha Lehmann,female,17,0,0,12');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Mr. William Ernest Carter,male,36,1,2,120');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Carl Olof Jansson,male,21,0,0,7.7958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Erik Johansson,male,22,0,0,7.7958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Miss. Elina Olsson,female,31,0,0,7.8542');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Peter David McKane,male,46,0,0,26');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Dr. Alfred Pain,male,23,0,0,10.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Juha Niskanen,male,39,0,0,7.925');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. John Adams,male,26,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Shadrach Gale,male,34,1,0,21');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Miss. Ida Lefebre,female,3,3,1,25.4667');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Todor Sdycoff,male,42,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Henry Hart,male,27,0,0,6.8583');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Miss. Daisy E Minahan,female,33,1,0,90');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Johan Julian Sundman,male,44,0,0,7.925');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. William John Matthews,male,30,0,0,13');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. David Charters,male,21,0,0,7.7333');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Leo Zimmerman,male,29,0,0,7.875');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Phillippe Wiseman,male,54,0,0,7.25');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. James Flynn,male,28,0,0,7.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. William Baird Silvey,male,50,1,0,55.9');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Miss. Lucile Polk Carter,female,14,1,2,120');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Mark Fortune,male,64,1,4,263');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Leon Hampe,male,20,0,0,9.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Johan Emil Petterson,male,25,1,0,7.775');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Ms. Encarnacion Reynaldo,female,28,0,0,13');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Edwy Arthur West,male,36,1,2,27.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Joseph Peduzzi,male,24,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Ivan Jalsevac,male,29,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Francis Davis Millet,male,65,0,0,26.55');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Ellen Toomey,female,50,0,0,10.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
INSERT INTO Passenger (Survived,Pclass,Name,Sex,Age,SIBLINGS_SPOUSES_ABOARD,PARENTS_CHILDREN_ABOARD,Fare) VALUES (' 0,
        3,
        Miss.Bridget Mary O 'Sullivan,female,21,0,0,7.6292'
    );
INSERT INTO Passenger (
        Survived,
        Pclass,
...
VALUES ('1,1,Miss. Roberta Maioni,female,16,0,0,86.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Mr. George Bradley,male,37,0,0,26.55');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Henry Margido Olsen,male,28,0,0,22.525');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Fang Lang,male,26,0,0,56.4958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Eugene Patrick Daly,male,29,0,0,7.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. James Webber,male,66,0,0,8.05');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Satio Coleff,male,24,0,0,7.4958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Patrick Ryan,male,30,0,0,24.15');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Stefo Pavlovic,male,32,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Miss. Anne Perreault,female,30,0,0,93.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Janko Vovk,male,22,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Sarkis Lahoud,male,35,0,0,7.225');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Fared Kassem,male,18,0,0,7.2292');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. James Farrell,male,40.5,0,0,7.75');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Lucy Ridsdale,female,50,0,0,10.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. John Farthing,male,49,0,0,221.7792');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Johan Werner Salonen,male,39,0,0,7.925');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Phyllis May Quick,female,2,1,1,26');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Nakli Toufik,male,17,0,0,7.2292');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Joseph Jr Elias,male,17,1,1,7.2292');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Miss. Marija Cacic,female,30,0,0,8.6625');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Eva Miriam Hart,female,7,0,2,26.25');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Miss. Bertha LeRoy,female,30,0,0,106.425');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Samuel Beard Risien,male,69,0,0,14.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Miss. Harriet R Crosby,female,36,0,2,71');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Mr. Edward Beane,male,32,1,0,26');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. Arthur Ernest Nicholson,male,64,0,0,26');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Percival James R Sharp,male,27,0,0,26');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
INSERT INTO Passenger (Survived,Pclass,Name,Sex,Age,SIBLINGS_SPOUSES_ABOARD,PARENTS_CHILDREN_ABOARD,Fare) VALUES (' 0,
        3,
        Mr.Patrick D O 'Connell,male,18,0,0,7.7333'
    );
INSERT INTO Passenger (
        Survived,
        Pclass,
...
VALUES ('1,1,Dr. Max Stahelin-Maeglin,male,32,0,0,30.5');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,1,Mr. William Henry Marsh Parr,male,30,0,0,0');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Miss. Mabel Skoog,female,9,3,2,27.9');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Mary Davis,female,28,0,0,13');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,2,Mr. Harvey Collyer,male,31,1,1,26.25');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Percival Thorneycroft,male,37,1,0,16.1');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Hans Peder Jensen,male,20,0,0,7.8542');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,1,Mlle. Emma Sagesser,female,24,0,0,69.3');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,3,Mr. Choong Foo,male,32,0,0,56.4958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Liudevit Cor,male,19,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Edward Willey,male,21,0,0,7.55');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('0,3,Mr. Mito Mitkoff,male,23,0,0,7.8958');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
...
VALUES ('1,2,Miss. Elsie Doling,female,18,0,1,23');
INSERT INTO Passenger (
        Survived,
        Pclass,
        Name,
